machine SATSLandingProtocol_II

satisfies safety 
atmost(4, {Enter}) && atmost(2, {HoldLeft}) && atmost(1, {FinalApproach: direction == 1})
...
crash locations: Fly, Enter, HoldLeft, HoldRight, Ask, Collect, Base, Idle, FinalApproach, Runway;
