...
public class WellBehavednessLowTransNoFirability {
	 ...
	 * @param b 
	 ***************************************/
	public WellBehavednessLowTransNoFirability(ProcessSemantics semantics, Options options) {
	...
	// public WellBehavednessLowTrans(ProcessSemantics semantics, PhaseAnalysis pa)
	// {
	// this(semantics, pa, true);
	// }
	...
	public boolean check() {
		...
		// (2) Every state in P which has an (globally-synchronizing) acting transition
		// must have the corresponding reacting transition from the same state.
		// if (!allGlobalSyncActionsPaired()) {
		// return false;
		// }
